...
export const useCompany = ({ _companyService, deleteRef }: Props): any => {
  const [state, setState] = useState({
    toDelete: '',
    payload: { id: '', name: '', modules: [] },
  ...
  const handleDelete = (): void => {
    _companyService
      ...
      .then(res => {
        ...
        alert(`Company ${res.name} removed with success`)
  ...
  useEffect(() => {
    ...
    _companyService
      ...
      .then((res: any) => {
        ...
        setState(old => ({
          ...old,
          companies: { data: companiesData, total: +res.total },
        }))
      })
      .catch(e => {
        console.error(e.message)
